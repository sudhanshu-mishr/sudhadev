  ...
  useEffect(() => {
    const syncPointer = (e: PointerEvent) => {
      ...
      if (cardRef.current) {
        ...
        // Calculate relative to the element for a more precise local effect if desired,
        // but the requested implementation uses global screen coords for a "shimmer" effect.
